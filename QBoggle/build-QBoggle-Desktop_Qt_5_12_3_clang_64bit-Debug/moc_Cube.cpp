...
QT_MOC_LITERAL(1, 5, 12), // "cubesClicked"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 5) // "index"

    },
    "Cube\0cubesClicked\0\0index"
};
...
void Cube::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->cubesClicked((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Cube::cubesClicked)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Cube::cubesClicked(int _t1)
{
